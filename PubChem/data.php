...
createDynamicHTMLTable("All Data", "SELECT data.Pb_SID, data.Sub_Name, data.Sub_Syno, datacom.CID,
datacom.Info, bioassay_concise.Pb_Actvt_Otcom, bioassay_concise.Pb_Actvt_Url, bioassay_concise.Pb_Actvt_Score
FROM data
INNER JOIN datacom ON data.Pb_SID = datacom.Pb_SID
INNER JOIN bioassay_concise ON data.Pb_SID = bioassay_concise.Pb_SID
LIMIT 0 , 30" , $link);
mysql_close($link);
